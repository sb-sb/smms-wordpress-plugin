...
class Smms
{
	...
	function admin_upload_img() {
	    echo '<a class="button"  id="toggleModal" title="SMMS图床">SMMS图床</a><a href="javascript:;" class="file">选择文件<input id="admin-img-file" type="file" accept="image/*" multiple="multiple"></a><div class="modal">
